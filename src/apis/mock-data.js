    ...
    columns: [
      {
        ...
        cards: [
          {
            _id: "card-id-01",
            boardId: "board-id-01", // thuoc ve board nao
            columnId: "column-id-01", // thuoc ve column nao
            title: "Title of card 01",
            description: "Markdown Syntax (sẽ ở khóa nâng cao nhé)",
            cover:
              "https://thanhnien.mediacdn.vn/Uploaded/trucdl/2022_03_23/albumredvelvetlapkyluc3-3573.jpg",
      ...
      // xử lý lỗi empty column không kéo card mới vào được
      {
        _id: "column-id-04",
        boardId: "board-id-01",
